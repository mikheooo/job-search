...
>
> - **2026-09-10 — 2026-09-16: находки №16–№37.** Пять критических на путях
...
>   разделе «Перепись».
>
> - **№27 ждёт решения Миши.** Инвариант «форма изменилась → стоп» в проде
>   недостижим: замер показал, что он недостижим дважды — отпечаток не передаёт
>   ни один боевой вызов, и самих анкет в проде никто не создаёт; а если
>   включить наивно, семь правок из восьми на стороне работодателя дадут ложный
>   стоп. Три варианта — в разделе №27. Подробности по остальным находкам —
>   раздел «Находки №8–№37» ниже.
