...
>
> - **2026-09-10 — 2026-09-16: находки №16–№36.** Пять критических на путях
...
>   **1687 passed, 0 failed** (`errors=0 failures=0 skipped=0`, junitxml).
>
...
- Полный сьют: **1687 passed, 0 failed** (`--junitxml`; 1685 после №34, 1686
  после №36, 1687 после добивания №35).
