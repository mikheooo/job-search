...
>
> - **2026-09-10 — 2026-09-16: находки №16–№35.** Пять критических на путях
...
>   выключало сверку вакансии. Тестов в файле теперь 147, полный сьют
>   **1685 passed, 0 failed** (`errors=0 failures=0 skipped=0`, junitxml).
>
...
- `tests/test_ble001_fail_closed.py`: **137 → 147** тестов.
- Полный сьют: **1685 passed, 0 failed** (`--junitxml`).
